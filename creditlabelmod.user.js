...
(function() {
    ...
    async function mutations(e)
    {
        ...
        for (var i = 0; i < Missions.length; i++)
        {
            ...
            {
                if(childs[ic].className == 'creditsmissionlistlabel pull-right')
                {
                   existing = true;
                   break;
                }
            ...
            if(existing == true && e.mtid != undefined)
            {
                ...
                {
                    if(childs[ic2].className != 'creditsmissionlistlabel pull-right') continue;
            ...
            else //create
            {
                ...
                div_elem.setAttribute("class", "creditsmissionlistlabel pull-right");
    ...
    async function init()
    {
        ...
        for (var i = 0; i < Missions.length; i++)
        {
            ...
            // add div element
            var childNodes = Missions[i].firstElementChild.childNodes;
            var secondaryChildNodes = childNodes[0].firstElementChild.childNodes;
            //secondaryChildNodes[0].firstElementChild.before(div_elem);
            childNodes[0].append(div_elem);
        }
    }
